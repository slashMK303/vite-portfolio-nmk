      ...
      <section>
        <div className="navbar animate__animated animate__fadeInDown">
          <div className="navbar-icon">
            ...
            <div className="about">
              <a href="#aboutme">
                <img className="profile-img" src="img/profile.svg" />
              </a>
            </div>
            <div className="email">
              <a href="#">
        ...
        <div id="home" className="container">
          <div className="konten-home">
            ...
            <p className="detail animate__animated animate__fadeInLeftBig">
              I am a dedicated Full Stack Developer with approximately 2 years
              of experience in software
              <br />
              development. I specialize in creating responsive and functional
              web applications. On this
              <br />
              portfolio website, you will find a collection of my work,
              showcasing my skills in both frontend
              <br />
              and backend technologies. Explore my projects to see how I can
        ...
        <div id="aboutme" className="container-about-me">
          <div className="konten-about-me">
            ...
            >
              ...
              <br />
              approximately 2 years of experience in software development. I
              specialize in creating
              <br />
              responsive and functional web applications. Throughout my journey
              as a Full Stack
              <br />
              Developer, I have gained expertise in both frontend and backend
              technologies, allowing me
              <br />
              to deliver seamless and user-friendly digital experiences.
              <br />
              <br />
              Aside from my professional endeavors, I have a keen interest in 3D
              modeling, although I am
              <br />
              still exploring this field, and game development, where I am in
              the early stages of learning.
              <br />I am constantly motivated to expand my skill set and explore
              new horizons within the realm of
              <br />
